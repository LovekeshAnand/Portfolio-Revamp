      ...
      <main className="flex-1 relative z-10 max-w-4xl mx-auto px-6 md:px-12 w-full pb-24">
        ...
        <div className="flex flex-col gap-10">
          {blogPosts.map((post) => (
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-4 mb-4 font-mono text-[9px] tracking-wider text-neutral-500 select-none pointer-events-none">
              ...
              <p className="font-author text-sm text-neutral-400 font-light leading-relaxed mb-5">
                {post.summary}
              </p>

              <span className="inline-flex items-center gap-1 text-[10px] font-mono tracking-widest uppercase text-orange-400 select-none pointer-events-none group-hover:underline">
                Read Dispatch
                <svg className="w-3 h-3 transform group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 16 16" stroke="currentColor" strokeWidth={2}>
